...
$(document).ready(function() {
    ...
    var style = $('<style>.duplicate-button{position:absolute;bottom:10px;right:50px;cursor:pointer;background:#ffffffdb;border:1px solid;border-radius:10px;padding:5px 10px;}.remove-button{position:absolute;bottom:10px;right:10px;cursor:pointer;background:#ffffffdb;border:1px solid;border-radius:10px;padding:5px 10px;}.editorBorder{border:2px dashed #0F3D5F;position:relative;}</style>');
