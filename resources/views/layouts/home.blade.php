...
<head>
    ...
    <title>Online Website Editor @yield('title') | {{ config('app.name') }}</title>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <meta name="title" content="Free Online HTML Website Editor">
  <link
  <meta name="description" content="Just type your website address to edit text and images on your website. Nothing to install, download or learn.">
  <link
