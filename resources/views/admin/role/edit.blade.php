            ...
            <div class="col-lg-6">
                <div class="card card-primary">
                    <div class="card-header card_hand">
                        <h3 class="card-title card_tit">Edit Role</h3>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="sedi" action="{{ route('admin.role.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="role_name" for="name" class="form-label">Role Name</label>
                        ...
                        <!-- /.card-body -->
                        <div class="card-footer float-end cv1 float-right">
