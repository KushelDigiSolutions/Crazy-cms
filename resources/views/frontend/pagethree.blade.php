...
<div class=" planCont com1">
  ...
  <div class="row row1 justify-content-md-center">
    <div class="col-lg-12 col-sm-10 hghgk  text-center">
      ...
      <p class="same_some mt-3">There are three different options available for CrazySimpleCMS Content Management System. The <span>Standard</span>  Plan is a robust website editor that works for most application.  The <span>Professional</span>  Plan includes everything, PLUS the enhanced Data Base Features. The <span>Premium</span>  Plan is advance website editing tools.</p>
    </div>
  </div>
